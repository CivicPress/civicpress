...
| `triaged-phase-2c` | 2 | Phase 2c Foundation Cleanup in-scope (still open): core-001, core-013 — the audit-trail-unification exit-criteria items handled by Task 9 |
