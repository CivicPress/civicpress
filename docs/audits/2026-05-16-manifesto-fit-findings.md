...
| `triaged-phase-2c` | 3 | Phase 2c Foundation Cleanup in-scope (still open): core-001, core-010, core-013 — the audit-trail-unification + notifications-split exit-criteria items handled by Tasks 8 + 9 |
...
| `closed-with-commit-SHA` | 35 | 2a (17) + 2b Task 1 (3) + 2b Task 4 (2) + 2b Task 5 (1) + 2b Tasks 8-11 (2: ui-005, cli-001) + 2c Tasks 3-7 (10: core-004/5/6, api-008, storage-003/4/9, notifications-005/6/13) |
