...
| `closed-with-commit-SHA` | 37 | 2a (17) + 2b Task 1 (3) + 2b Task 4 (2) + 2b Task 5 (1) + 2b Tasks 8-11 (2: ui-005, cli-001) + 2c Tasks 3-7 (10: core-004/5/6, api-008, storage-003/4/9, notifications-005/6/13) + 2c Task 9 (2: core-001, core-013). **Original-205 only.** Phase-2c-surfaced closures (email-validation-regression, ui-record-form-emit, ui-geography-form-nullguard, docs-overclaim-architecture, docs-overclaim-5, ci-truth-check) and Phase-2c.5-surfaced closures (phase-2c.5-followup-1/2/3/4) tracked as separate rows in the Closed findings table below; not counted in the original-205 truth-meter. |
