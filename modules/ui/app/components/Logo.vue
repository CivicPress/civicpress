...
<template>
    <div class="flex items-center gap-2">
        <img :src="logoSrc" :class="sizeClasses[size]" alt="CivicPress Logo" class="flex-shrink-0 dark:invert" />
        <span v-if="showText" class="font-bold tracking-wide text-gray-900 dark:text-gray-100">
            {{ organizationName }}
        </span>
    </div>
</template>