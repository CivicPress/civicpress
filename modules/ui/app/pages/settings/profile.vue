            ...
            <div v-else-if="userInfo" class="space-y-6">
                ...
                <div class="rounded-lg border p-6">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <div class="flex items-center space-x-2">
                                ...
                                <UButton @click="copyToken" :color="(tokenCopied ? 'green' : 'primary') as any"
                                    variant="soft" size="sm" :disabled="!authStore.token">
                                    <template #leading>
                                        <UIcon :name="tokenCopied ? 'i-lucide-check' : 'i-lucide-copy'"
                                            class="w-4 h-4" />
                                    </template>
                        ...
                        <div>
                            ...
                            <div class="flex items-center space-x-2">
                                <UInput :model-value="`Bearer ${authStore.token || 'your-token-here'}`" readonly
                                    class="flex-1 font-mono text-xs" size="sm" />
                                <UButton @click="copyAuthHeader" :color="(tokenCopied ? 'green' : 'primary') as any"
                                    variant="soft" size="sm" :disabled="!authStore.token">
                                    <template #leading>
                                        <UIcon :name="tokenCopied ? 'i-lucide-check' : 'i-lucide-copy'"
                                            class="w-4 h-4" />
                    ...
                    <div class="mt-4 p-4 bg-blue-50 rounded-lg">
                        <h3 class="text-sm font-medium text-blue-900 mb-2">💡 API Testing Tips</h3>
                        <ul class="text-sm text-blue-800 space-y-1">
                            <li>• Add the token to your Postman collection environment variables</li>
                            <li>• Use the Authorization header: <code
                                    class="bg-blue-100 px-1 rounded">Bearer YOUR_TOKEN</code></li>
                            <li>• Test with: <code class="bg-blue-100 px-1 rounded">GET /auth/me</code></li>
