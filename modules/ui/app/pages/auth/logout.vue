        ...
        <template #body>
            <div class="flex justify-center items-center h-full">
                <UCard class="w-full max-w-md">
                    ...
                    <div v-if="authStore.currentUser" class="mb-6 p-4 bg-gray-50 rounded-lg">
                        <div class="flex items-center space-x-3">
                            <UAvatar v-if="authStore.currentUser.avatar" :src="authStore.currentUser.avatar"
                                :alt="authStore.currentUser.name" size="md" />
                    ...
                    <div class="mb-6">
                        <UAlert color="primary" variant="soft" title="You will be signed out"
                    ...
                    <template #footer>
                        <div class="w-full text-right ">
                            ...
                            <UButton variant="ghost" @click="handleCancel" :disabled="loading" class="mr-2">
                                Cancel
                            </UButton>
                            <UButton color="primary" @click="handleLogout" :loading="loading" :disabled="loading"
                                class="">
