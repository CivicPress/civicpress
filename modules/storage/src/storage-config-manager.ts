    ...
    this.defaultConfig = {
      ...
      folders: {
        ...
        attachments: {
          ...
          max_size: '25MB',
          description:
            "Files uploaded from the record editor. `authenticated` so a DRAFT record's attachments are staff-only; they become publicly readable the moment a record referencing them is published (see isFileReferencedByPublishedRecord).",
        },
        permits: {
          path: 'permits',
          access: 'authenticated',
